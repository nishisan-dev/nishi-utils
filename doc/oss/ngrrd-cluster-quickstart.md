...
Os comandos abaixo usam a versão `8.3.0` do POM desta branch. Se a versão mudar, ajuste o nome
...
```bash
java -cp 'nishi-utils-ngrrd-cluster/target/nishi-utils-ngrrd-cluster-8.3.0.jar:nishi-utils-ngrrd-cluster/target/lib/*' \
